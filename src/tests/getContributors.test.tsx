...
const mockData = [
  ['http://localhost:5000/api/repos/facebook/react/contributors?page=2'],
  [
...
// have to start server - need to mock getData

test('getContributors has correct length', async () => {
  expect((await getContributors(mockData)).length).toBe(396);
});
